$(call inherit-product-if-exists, vendor/lge/AS855/AS855-vendor.mk)

include device/lge/sniper/device.mk

DEVICE_PACKAGE_OVERLAYS += device/lge/AS855/overlay

# XXX: Don't know what to do about these...
CDMA_GOOGLE_BASE := android-lge-us
